...
# Define the swaggerui_blueprint and SWAGGER_URL variables
SWAGGER_URL = '/api/docs'  # The URL for accessing the Swagger UI
API_URL = '/swagger.json'  # The URL where the Swagger JSON file is served
...
swaggerui_blueprint = get_swaggerui_blueprint(
    ...
    API_URL,
    config={
        'app_name': "challenge-api"  # Optional: Customize the Swagger UI app name
    }
)
